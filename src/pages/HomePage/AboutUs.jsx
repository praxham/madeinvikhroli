...
const AboutUs = ({translateToMarathi}) => {
  ...
  return (
    <div ref={ref} className="container4 w-fit mx-4 lg:w-[1240px] h-fit  lg:mx-auto mb-[100px] text-center text-white">
      ...
      <div className="w-full flex flex-col gap-4 z-20">
        <div className="h-1/2 w-full flex flex-col lg:flex-row gap-4">
          <div className="lg:w-1/3 w-full h-full flex flex-col items-center gap-4 bg-[#1A1A1A] p-4 rounded-[15px] hover:border-mivCol hover:border-[1px]">
      ...
      <div className="mt-4 flex flex-col items-start text-left gap-4">
        <p>We're a group dedicated to presenting innovative artistic and tech projects. Our mission is to inspire and create while being mindful of our environmental impact.</p>
