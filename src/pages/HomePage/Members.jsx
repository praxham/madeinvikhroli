...
const Members = ({translateToMarathi}) => {
  ...
  return (
    <div className="container3 w-full lg:w-[1240px] mx-auto mb-16 text-center">
          ...
          return (
            // <SwiperSlide>
              <CardContainer className="lg:w-fit w-full mx-4 flex flex-col gap-2 items-start bg-[#1A1A1A] p-4 rounded-[15px] text-white text-4 font-medium">
                ...
                >
                  <a className="flex flex-row gap-2 items-center" href={`https://instagram.com/${membersData.igUsername}`}>
